<template>
  <div class="role-page">
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <el-button @click="allotOpen(scope.row.id,scope.row.roleName,scope.row.mechanismId)" type="text" size="small">分配</el-button>
    ...
    <!--分配角色弹层-->
    <el-dialog title="分配角色" :visible.sync="assignRolePop" class="tip-dialog assign-dialog"
               :close-on-click-modal="false">
      <div class="pop-content">
        <div class="search-nav">
          <el-row :gutter="20" style="margin-bottom:20px;">
            <el-col :span="8" class="flex">
              <span class="name">角色名称： <span class="bold">{{fpName}}</span></span>
            </el-col>
            <el-col :span="8" class="flex">
              <span class="name">归属机构： <span class="bold">{{fpJg}}</span></span>
            </el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="8" class="flex">
    ...
    <!--分配角色弹层-->
    <el-dialog title="分配角色" :visible.sync="assignRoleDetailPop" class="tip-dialog assign-detail-dialog"
               :close-on-click-modal="false">
      <div class="pop-content">
        <div class="role-cell">
        ...
        <div class="role-cell">
          ...
          <div class="role-cell-content">
            <div class="user"
                 ...
                 :key="list.id"
                 @click="chooseRoleClick(list)"><i class="fa fa-user"></i> {{list.label}}
            </div>
          </div>
        </div>
        <div class="role-cell">
          ...
          <div class="role-cell-content">
            <div class="user" :style="{color:'red'}"
                 ...
                 :key="list.id"
                 @click="delRoleClick1(index)"><i class="fa fa-user"></i> {{list.label}}
            </div>
            <div class="user"
                 v-for="(list,index) in chooseUserData2"
                 @click="delRoleClick2(index)"><i class="fa fa-user"></i> {{list.label}}
            </div>
          </div>
        </div>
      </div>
